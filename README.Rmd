...
While writing [wordpiece](https://github.com/jonathanbratt/wordpiece) and [morphemepiece](https://github.com/jonathanbratt/morphemepiece), we found that many steps were shared between those package.
